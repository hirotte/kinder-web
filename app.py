...
with tab1:
    ...
    st.markdown("###### 筋肉には、足の筋肉（Leg Muscles）、お尻の筋肉（Butt Muscles）、背中の筋肉（Back Muscle）、胸の筋肉（Chest Muscles）、など、数多くの部位があります。\n ###### 理想の筋肉を探している人も、似あう筋肉を探している人も、自分にぴったりの相手を見つけられるアプリを求めています。\n###### 筋肉に何を求めているか、自分はどんな風になりたいのかハッキリしないこともありますが、筋derにはさまざまな筋肉との出会いを可能にするための数々の機能が備わっています。\n###### 筋肉との出会いが、より簡単になりました。筋derが最高の無料アプリだと断言する前に、実際に筋derを使用して頂き、みなさん自身に判断してもらいたいと思っています。\n###### 皆様の理想の筋肉を見つけられるように応援させていただきます。")
